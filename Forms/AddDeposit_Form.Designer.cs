namespace deposit_app.Forms
{
	partial class AddDeposit_Form
	{
		...
		private void InitializeComponent()
		{
			...
			personalAccount_maskedTextBox1 = new MaskedTextBox();
			SuspendLayout();
			// 
			// label1
			// 
			...
			label10.Location = new Point(27, 297);
			...
			// duration_textBox
			// 
			duration_textBox.Location = new Point(28, 320);
			...
			// 
			// personalAccount_maskedTextBox1
			// 
			personalAccount_maskedTextBox1.Location = new Point(28, 271);
			personalAccount_maskedTextBox1.Mask = "9999999999";
			personalAccount_maskedTextBox1.Name = "personalAccount_maskedTextBox1";
			personalAccount_maskedTextBox1.Size = new Size(212, 23);
			personalAccount_maskedTextBox1.TabIndex = 22;
			// 
			// AddDeposit_Form
			// 
			...
			Controls.Add(personalAccount_maskedTextBox1);
		...
		private MaskedTextBox personalAccount_maskedTextBox1;
	}
}